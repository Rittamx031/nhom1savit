let app_material = angular.module("material", []);
app_material.controller("material-ctrl", function ($scope, $http, $timeout){
    $scope.materials = [];
    $scope.formUpdate = {};
    $scope.formInput = {};
    ...
    $scope.create = function() {
        ...
        $http.post(`/rest/materials`, item).then(resp => {
    ...
    $scope.update = function() {
        ...
        $http.put(`/rest/materials/${item.id}`, item).then(resp => {
    ...
    $scope.delete = function(item) {
        $http.delete(`/rest/materials/${item.id}`).then(resp => {
    ...
    $scope.resetFormInput = function () {
        $scope.formInput = {};
        $scope.formAddMaterial.$setPristine();
        $scope.formAddMaterial.$setUntouched();
    }
