...
@Service
public class SizeService implements PanigationInterface<SizeResponse> {
  @Autowired
  SizeRepository repository;

  @Override
  public List<SizeResponse> getPageNo(int pageNo, int pageSize, String sortBy, boolean sortDir) {
  ...
  public int getPageNumber(int rowcount) {
    ...
    Page<SizeResponse> page = repository.getResposePage(pageable);
