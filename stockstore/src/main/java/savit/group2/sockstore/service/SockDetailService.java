 ...
 */
@Service
public class SockDetailService implements PanigationInterface<SockDetailResponse> {
  @Autowired
  SockDetailRepository repository;

  @Override
  public List<SockDetailResponse> getPageNo(int pageNo, int pageSockDetail, String sortBy, boolean sortDir) {
    ...
    Pageable page = PageRequest.of(pageNo, pageSockDetail, sort);
  ...
  public int getPageNumber(int rowcount) {
    ...
    Page<SockDetailResponse> page = repository.getResposePage(pageable);
